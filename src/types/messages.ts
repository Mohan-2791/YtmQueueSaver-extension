import type { Category, SnapshotCreatePayload, Track, PlaybackMode } from './snapshots';

/**
 * Discriminated union of all messages passed between content scripts,
